...
5.  You will notice, that for `tidyverse` the install failed because it has an R dependency called `haven`.  Therefore, follow the recommendation to install `haven`:
